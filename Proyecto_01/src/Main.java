    ...
    public static void main(String[] args) throws IOException {
        ...
        while (!salida) {
            ...
            switch (opcionesDos) {
                ...
                case 9:
                    System.out.println("\n=============================================");
                    System.out.println("¿Cómo desea buscar el contacto?");
                    System.out.println("1. Buscar por ID");
                    System.out.println("2. Buscar por nombre, apellido, apodo, dirección o email");
                    ...
                    if (opcionBusqueda == 1) {
                        ...
                        System.out.print("Ingrese un dato (nombre, apellido, apodo, dirección o email): ");
                        String dato = scanner.nextLine();
                        boolean encontrado = false;
                        for (int i = 0; i < array.length; i++) {
                            if (array[i] != null) {
                                array[i].searchStringer(dato);
                                encontrado = true;
                            }
                            if (arrayAVL[i] != null) {
                                arrayAVL[i].searchStringer(dato);
                                encontrado = true;
                            }
                        }
                        if (!encontrado) {
                            System.out.println("No se encontraron coincidencias con el dato: " + dato);
                        }
                    } else {
